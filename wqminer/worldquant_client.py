...
class WorldQuantBrainClient:
    BASE_URL = os.environ.get("BRAIN_API_BASE_URL", "")
    PLATFORM_ALPHA_URL = os.environ.get("BRAIN_PLATFORM_BASE_URL", "") + "/alpha/"
    ...
    def submit_alpha(
        ...
        *,
        ...
        if not allow_http_fallback:
            return resp
        if resp.status_code in (404, 405) and self.base_url:
            fallback_url = f"{self.base_url}/alphas/{alpha_id}/submit"
