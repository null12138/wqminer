...
_BRAIN_API_BASE = os.environ.get("BRAIN_API_BASE_URL", "").rstrip("/")

HTTP_API_WORLDQUANTBRAIN_COM = _BRAIN_API_BASE
HTTPS_API_WORLDQUANTBRAIN_COM = _BRAIN_API_BASE
...
URL_ALPHAS_ALPHAID_SUBMIT = _BRAIN_API_BASE + '/alphas/{}/submit'
